        ...
        <div className="flex flex-col lg:flex-row h-full overflow-hidden">
          ...
          <div className="relative w-full lg:w-2/5 h-56 xs:h-64 sm:h-72 md:h-96 lg:h-auto lg:min-h-[600px] flex-shrink-0">
            ...
            <div className="absolute top-3 xs:top-4 sm:top-6 left-3 xs:left-4 sm:left-6 bg-white/95 backdrop-blur-sm px-2 py-1 xs:px-3 xs:py-1.5 sm:px-4 sm:py-2 rounded-full shadow-lg border border-white/50">
              <span className="text-xs xs:text-sm font-semibold text-blue-600">{expert.specialty}</span>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-1 overflow-y-auto px-4 xs:px-5 sm:px-6 lg:px-8 py-4 xs:py-5 sm:py-6">
              ...
              <div className="grid grid-cols-3 gap-2 xs:gap-3 sm:gap-4 mb-5 xs:mb-6 sm:mb-8 p-3 xs:p-4 sm:p-5 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl xs:rounded-2xl border border-blue-100">
                <div className="text-center">
                  <div className="text-xl xs:text-2xl sm:text-3xl mb-1 xs:mb-2">⭐</div>
                  <div className="text-base xs:text-lg sm:text-xl font-bold text-gray-800">4.9</div>
                  <div className="text-[10px] xs:text-xs text-gray-600 font-medium">Đánh giá</div>
                </div>
                <div className="text-center">
                  <div className="text-xl xs:text-2xl sm:text-3xl mb-1 xs:mb-2">📚</div>
                  <div className="text-base xs:text-lg sm:text-xl font-bold text-gray-800">{expert.description.length}</div>
                  <div className="text-[10px] xs:text-xs text-gray-600 font-medium">Chứng chỉ</div>
                </div>
                <div className="text-center">
                  <div className="text-xl xs:text-2xl sm:text-3xl mb-1 xs:mb-2">✅</div>
                  <div className="text-base xs:text-lg sm:text-xl font-bold text-green-600">Verified</div>
                  <div className="text-[10px] xs:text-xs text-gray-600 font-medium">Xác minh</div>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                ...
                {expert.description.map((desc, index) => (
                  <div key={index} className="group flex items-start gap-3 xs:gap-4 p-3 xs:p-4 sm:p-5 rounded-xl xs:rounded-2xl bg-white border border-gray-200 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
            ...
            <div className="p-4 xs:p-5 sm:p-6 lg:p-8 bg-gray-50 border-t border-gray-100 flex-shrink-0">
              <div className="flex flex-col sm:flex-row gap-3">
                <button className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 xs:py-3.5 sm:py-4 px-4 xs:px-5 sm:px-6 rounded-lg xs:rounded-xl font-medium text-sm xs:text-base transition-all duration-300 hover:from-blue-600 hover:to-blue-700 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]">
                  Liên hệ chuyên gia
                </button>
                <button 
                  onClick={onClose}
