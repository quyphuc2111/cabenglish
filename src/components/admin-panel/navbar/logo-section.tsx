  ...
  return (
    <div className="w-fit">
      <div className="flex items-center justify-center">
        <div
          className={cn(
            "font-extrabold text-[14px] sm:text-[16px] lg:text-[20px] xl:text-[22px] 2xl:text-[28px] tracking-[2px] sm:tracking-[3px] lg:tracking-[4.20px]",
        ...
        <span
          className={cn(
            "ml-1 text-[14px] sm:text-[16px] lg:text-[21px] xl:text-[22px] 2xl:text-[28px] font-black tracking-[2px] sm:tracking-[3px] lg:tracking-[4.20px]",
