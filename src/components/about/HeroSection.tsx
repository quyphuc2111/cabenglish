      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-20">
        <div className="flex flex-col gap-6 sm:gap-8 lg:gap-10 max-w-3xl">
          ...
          <p className="text-base sm:text-lg text-gray-700 text-justify">
            SmartKids là phần mềm học trực tuyến dành cho trẻ mầm non, được
            thiết kế để mang đến trải nghiệm học tập thú vị và hiệu quả cho các
            bé dưới 6 tuổi. Với SmartKids, trẻ sẽ được khám phá thế giới học tập
            qua các bài học tương tác, trò chơi giáo dục, và video hấp dẫn. Phần
            mềm bao gồm các môn học cơ bản như toán, tiếng Việt, tiếng Anh, cùng
            với các hoạt động phát triển kỹ năng tư duy và sáng tạo. <br />{" "}
            <br /> SmartKids được xây dựng dựa trên các phương pháp giáo dục
            tiên tiến, đảm bảo phù hợp với từng giai đoạn phát triển của trẻ.
            Giao diện thân thiện, dễ sử dụng và hình ảnh sinh động giúp các bé
