...
import { useDeleteSectionContent } from "@/hooks/useSectionContent";
...
interface DeleteSectionContentModalProps {
  onConfirm?: () => void;
}

function DeleteSectionContentModal() {
...
export default DeleteSectionContentModal;
