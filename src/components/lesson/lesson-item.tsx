...
function LessonItem({
  ...
  return (
    <div className="w-full">
      ...
      <div className="absolute -right-[132px] top-0">
        <div className="bg-[#f5fcff] w-[132px] h-[800px] ">
          <div className="p-7 text-white bg-[#00cccc] rounded-tl-3xl">
            <h2 className="text-2xl font-semibold">Unit 9</h2>
            <p className="text-lg tracking-wide">Từ vựng</p>
          </div>
      ...
      <div
        className={` w-[980px] h-[800px] -right-[1113px] top-0 absolute overflow-hidden bg-white`}
      >
       {activeIndexTab === 1 && (
    <div>
      <Video src={learning} />
   ...
   <div className="flex items-start gap-7 mt-3">
        ...
        <p className="how-to-play bg-[#f5f5f5] p-9 rounded-3xl border relative">
          Cùng Pea học Tiếng Anh qua Video bài giảng thú vị sau đây nhé. Nếu
