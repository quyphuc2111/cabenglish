  ...
  return (
    <ContentLayout title="DoiNguChuyenGia">
      <CourseWrapper>
        ...
        {/* Grid Layout - Responsive cho nhiều thiết bị */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-7xl mx-auto px-2 sm:px-4">
              ...
              <div className="relative z-10 block">
                ...
                <div className="p-3 xs:p-4 sm:p-6 flex flex-col flex-1">
                  ...
                  <div className="mb-4">
                    ...
                    <p className="h-auto sm:h-11 text-xs sm:text-sm text-blue-600 font-medium leading-relaxed line-clamp-2">
                      {expert.title}
                    </p>
                  </div>

                  {/* Stats - Responsive spacing */}
                  <div className="flex flex-wrap items-center gap-2 xs:gap-3 sm:gap-4 mb-2 sm:mb-4 text-xs sm:text-sm text-gray-600">
                  ...
                  {/* Preview Description - Adjusted height */}
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100">
                    <button 
                      ...
                      className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl text-sm sm:text-base font-medium transition-all duration-300 hover:from-blue-600 hover:to-purple-700 hover:shadow-lg active:scale-95"
                    >
                      Xem chi tiết
                    </button>
                  </div>
        ...
        {/* Bottom Stats - Improved responsive layout */}
        <div className="mt-8 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto px-2 sm:px-4">
          {[
