  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="BKT - Đơn vị hàng đầu trong lĩnh vực công nghệ giáo dục, cung cấp giải pháp toàn diện cho việc học tập và giảng dạy." />
        <meta name="keywords" content="BKT, công nghệ giáo dục, edtech, elearning, giáo dục trực tuyến" />
        <meta property="og:title" content="BKT - Công ty cổ phần đầu tư thương mại và công nghệ" />
        <meta property="og:description" content="BKT - Đơn vị hàng đầu trong lĩnh vực công nghệ giáo dục" />
        ...
        <footer className="bg-[#005b94] text-white">
          <div className="py-6 md:py-20 border-t border-border/40 container">
            ...
            >
              ...
              >
                <div className="md:flex md:flex-wrap">
                  {[
                    {
                      city: "Hà Nội",
                      address: "Liền kề C39 Embassy Garden, Đ. Hoàng Minh Thảo, Khu đô thị Tây Hồ Tây, Bắc Từ Liêm, Hà Nội"
                    },
                    {
                      city: "Thanh Hóa",
                      address: "Số 15 Ngô Thì Nhậm, Phường Ngọc Trạo, TP Thanh Hóa, Tỉnh Thanh Hóa"
                    },
                    {
                      city: "Đà Nẵng",
                    ...
                    <motion.div 
                      ...
                      variants={fadeInUp}
                    >
                      <Badge className="mb-2 bg-green-600">{location.city}</Badge>
              ...
              <motion.div 
                className="col-span-1 md:px-5"
                variants={fadeInUp}
              >
                <h2 className="text-xl font-semibold mb-2">Hotline</h2>
                <ul className="flex flex-col gap-2">
                  <li>Điện thoại: <a href="tel:02437525253" className="hover:underline">0243 752 5253</a></li>
                  <li>Kỹ thuật (24/7): <a href="tel:0337218868" className="hover:underline">033 721 8868</a></li>
                  <li>Kinh doanh: <a href="tel:0868179599" className="hover:underline">086 817 9599</a></li>
                </ul>
              </motion.div>
            </motion.div>
            <p className="text-sm mt-3 text-center"> 
              Copyright © {new Date().getFullYear()} BKT Company | All Rights Reserved
            </p>
          </div>
        </footer>
      </div>
