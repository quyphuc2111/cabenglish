    ...
    <ContentLayout title="BaiGiangChuaDay">
      ...
      <div className="bg-white px-5 py-2 relative rounded-xl max-h-screen h-[75vh] ">
        ...
        <div className="flex flex-col items-center gap-10 h-full justify-center">
            <h3 className="text-3xl text-[#736E6E]">Hiện tại chưa có bài giảng nào!</h3>
            <div className="w-36 h-36">
            <Image src="/assets/image/no_course.png" width={512} height={512} alt="no_course" className="object-contain" />
            </div>
        </div>
