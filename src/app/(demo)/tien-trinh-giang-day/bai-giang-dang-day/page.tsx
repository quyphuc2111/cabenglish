       ...
       <div className="bg-white h-fit px-4 py-2 flex flex-col gap-5 rounded-xl">
        <SectionTitle
          ...
          />
            ...
            <CourseCard {...courseTest} />

            <Button className="bg-[#4079CE] w-full">Tiếp tục học</Button>
        </div>
      <div className="bg-white px-5 py-2 relative rounded-xl flex-1">
        ...
        <PaginatedContent
          ...
          itemsPerPage={6}
          rowPerPage={3}
          renderItem={(courseItem) => <CourseCard disabled {...courseItem} />}
        />
      </div>
       </div>
    </ContentLayout>
...
export default BaiGiangDangDayPage;
